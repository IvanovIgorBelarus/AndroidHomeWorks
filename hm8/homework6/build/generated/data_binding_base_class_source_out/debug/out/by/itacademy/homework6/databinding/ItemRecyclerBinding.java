...
public final class ItemRecyclerBinding implements ViewBinding {
  ...
  private ItemRecyclerBinding(@NonNull ConstraintLayout rootView, @NonNull TextView fileName) {
  ...
  public static ItemRecyclerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRecyclerBinding((ConstraintLayout) rootView, fileName);
    }
